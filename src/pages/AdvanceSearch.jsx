    ...
    <>
      ...
      <div className="w-full bg-white p-5 rounded-2xl shadow-sm my-5">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-5">
          <button
            type="button"
            className="px-2 md:px-6 py-1 md:py-2 rounded-md bg-red-600 hover:bg-red-700 text-white font-medium whitespace-nowrap pointer"
          ...
          >
            <Location className="text-red-600 size-4 md:size-5" /> Search On Map
          </button>

          <button
            type="button"
            className="px-2 md:px-6 py-1 md:py-2 rounded-md border border-gray-300 text-gray-600 font-medium whitespace-nowrap pointer"
            onClick={() => {
              setSearch('');
              setSearchEvent(null);
            }}
