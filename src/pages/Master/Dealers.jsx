  ...
  const modalForm = () => (
    <div className="w-full lg:min-w-xl max-w-[600px] bg-white rounded-xl overflow-hidden">
      <div className="bg-[#1A387D] px-6 py-4">
        <h2 className="text-white text-lg font-semibold">Add Dealer</h2>
      </div>
      ...
      <div className="px-6 py-5 grid grid-cols-2 gap-2 space-y-4 max-h-[70vh] overflow-y-auto scrollbar">
        ...
        <div className="col-span-2">
          <label className="block text-sm font-medium text-[#031B15] mb-1">Address</label>
          <textarea
            type="text"
            rows={2}
        ...
        <div>
          <label className="block text-sm font-medium text-[#031B15] mb-1">Country</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-[#031B15] mb-1">State Code</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-[#031B15] mb-1">Lat</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-[#031B15] mb-1">Long</label>
          <input
            type="text"
